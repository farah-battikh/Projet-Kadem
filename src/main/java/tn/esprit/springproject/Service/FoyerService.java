...
private JavaMailSender mailsender;
    ...
    public Foyer addFoyer(Foyer foyer) {
        ...
        String message = "Un nouveau foyer a été ajouté : " + addedFoyer.getNomFoyer();
    ...
    public List<Foyer> getAllFoyersSortedByName() {
        return foyerRespository.findAllSortedByName();
    }

    public StatistiquesFoyers getFoyersStatistics() {
        Double averageCapacity = foyerRespository.calculateAverageCapacity();
        Long maxCapacity = foyerRespository.findMaxCapacity();

        return new StatistiquesFoyers(averageCapacity, maxCapacity);
    }
